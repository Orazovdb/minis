...
export default function About() {
	...
	const titleText = useTranslate(
		`We are the brand that combines flavor and fun in the same package.
With Minis, we add a little color and a lot of taste to every day.`,
		`Lezzeti ve eğlenceyi aynı pakette buluşturan markayız.
Minis ile her gününüze biraz renk ve çokça tat katıyoruz.`
	);
